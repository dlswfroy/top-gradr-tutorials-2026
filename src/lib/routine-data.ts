...
const createInitialRoutine = async (db: Firestore, academicYear: string): Promise<ClassRoutine[]> => {
    ...
    '6': {
        ...
        'মঙ্গলবার': ['ইংরেজি ১ম - আরিফুর', 'শারীরিক - মাহাবুব', 'ধর্ম - নীলা', 'ইংরেজি ২য় - যুধিষ্ঠির', 'গণিত - ধনঞ্জয়', 'শারীরিক - মাহাবুব'],
        'বুধবার': ['কৃষি - জান্নাতুন', 'গণিত - ধনঞ্জয়', 'ধর্ম - নীলা', 'বাংলা ২য় - যুধিষ্ঠির', 'ইংরেজি ১ম - আরিফুর', 'আইসিটি - শারমিন'],
        'বৃহস্পতিবার': ['বাও বি - জান্নাতুন', 'বাংলা ২য় - যুধিষ্ঠির', 'ইংরেজি ১ম - আরিফুর', 'বাংলা ১ম - ওবায়দা', 'ইংরেজি ২য় - যুধিষ্ঠির', 'বিজ্ঞান - শান্তি'],
    },
    '7': {
    ...
    '8': {
        ...
        'বুধবার': ['গণিত - ধনঞ্জয়', 'বাংলা ১ম - ওবায়দা', 'কৃষি - জান্নাতুন', 'ধর্ম - মাহাবুব/নীলা', 'বাংলা ২য় - যুধিষ্ঠির', 'আইসিটি - শারমিন'],
        'বৃহস্পতিবার': ['শারীরিক - নীলা', 'কৃষি - জান্নাতুন', 'গণিত - ধনঞ্জয়', 'কৃষি - জান্নাতুন', 'ইংরেজি ১ম - আরিফুর', 'বিজ্ঞান - শান্তি'],
    },
    '9': {
